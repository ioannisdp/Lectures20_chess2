...
--
-- Host: localhost    Database: adise20_chess2
-- ------------------------------------------------------
...
INSERT INTO `board` VALUES (1,1,'B','W','R'),(2,1,'W','W','N'),(3,1,'B','W','B'),(4,1,'W','W','K'),(5,1,'B','W','K');
...
INSERT INTO `game_status` VALUES ('not active','W','B',NULL),('not active','W','B',NULL),('not active','B','W',NULL),('not active','B','W',NULL),('not active','W',NULL,NULL),('initialized','B','W',NULL);
...
--
-- Dumping routines for database 'adise20_chess2'
--
...
-- Dump completed on 2021-08-12 19:00:50
